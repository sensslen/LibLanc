...
class Lanc
{
  public:
     ...
     */
    bool setCommand(liblanc::unique_ptr<ILancCommand> command);
  ...
  protected:
     ...
     */
    Lanc(liblanc::unique_ptr<Phy::IPhysicalLayer> physicalLayer);
    ...
    liblanc::unique_ptr<ILancCommand> _activeCommand;

  private:
    liblanc::unique_ptr<ILancCommand> _nextCommand;
};
